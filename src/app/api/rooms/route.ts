...
const ROOM_TYPES = ["PHONG_MAU_ME", "PHONG_RA_RE", "PHONG_TOI", "PHONG_NHIEM", "PHONG_DAT_TIEU_CHUAN", "PHONG_THEO_DOI", "PHONG_HAN_TUI", "PHONG_THI_TRUONG", "PHONG_SAN_PHAM_DAT", "PHONG_SAN_PHAM_KHONG_DAT", "PHONG_CAY_TRONG"] as const;
