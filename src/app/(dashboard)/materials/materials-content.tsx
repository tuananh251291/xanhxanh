...
// Tách khỏi page.tsx để dùng lại được y hệt ở cả route gốc (/materials) lẫn tab "Vật tư" trong hub
// /master-data — xem plan gộp menu Admin, tránh trùng lặp logic.
export default async function MaterialsContent({ role }: { role: UserRole | null }) {
