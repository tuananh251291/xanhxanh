...
import { ClipboardList, Printer, Search, ChevronLeft, ChevronRight, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-foreground">Chỉ định cấy đã tạo</h1>
