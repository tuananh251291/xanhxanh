...
// Tách khỏi page.tsx để dùng lại được y hệt ở cả route gốc (/product-prices) lẫn tab "Bảng giá sản phẩm"
// trong hub /master-data — xem plan gộp menu Admin, tránh trùng lặp logic.
export default async function ProductPricesContent() {
