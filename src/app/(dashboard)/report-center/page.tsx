...
import { BarChart3, TrendingUp, Gauge, Images, ChevronRight, Truck } from "lucide-react";
...
export default async function ReportCenterPage() {
  ...
  const cards = [
    ...
    { href: "/reports/goods-receipt-summary", icon: Truck, title: "Hàng nhập đạt từ NCC", description: "Tổng số lượng nhận và số lượng được ghi nhận theo từng nhà cung cấp, lọc theo tháng." },
    ...(role === "SUPER_ADMIN"
