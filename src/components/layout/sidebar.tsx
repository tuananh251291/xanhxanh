...
import {
  ...
  Recycle, Truck, ArrowLeftRight, PackagePlus, TrendingUp, CalendarPlus,
} from "lucide-react";
...
const ICON_MAP: Record<string, React.ElementType> = {
  ...
  Settings, ClipboardList, ClipboardCheck, Sun, Moon, PenLine, PackageCheck,
  PackageOpen, Package, AlertTriangle, ShoppingCart, ShoppingBag, Sprout,
  UserCircle, Flag, Boxes, Send, Layers, UploadCloud, Recycle, Truck, ArrowLeftRight, PackagePlus, TrendingUp, CalendarPlus,
};
